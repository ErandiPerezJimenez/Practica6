...
float radius = 2.0f;        // Radio del círculo en el que se moverá la luz
float angle = 0.0f;         // Ángulo actual (en radianes)
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Draw the loaded model casa de campaña
        glm::mat4 model(1);
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
    ...
    glm::vec3 movelightPos = glm::vec3(radius, 0.0f, 0.0f); // Posición inicial de la luz 
    ...
    /////////////////////////////////PARA LA LUNA//////////////////////////////////////////
    // Incrementar o decrementar el ángulo para mover en sentido antihorario (tecla O) o horario (tecla L)
    ...
    // Envolver el ángulo entre 0-180
    if (angle > M_PI) {
        angle -= 2 * M_PI;
    }
    else if (angle < -M_PI) {
    ...
    /////////////////////////////////PARA EL SOL //////////////////////////////////////////   
    // Incrementar el ángulo para mover en sentido antihorario (tecla C)
    angle += (keys[GLFW_KEY_C] && angle < M_PI) ? 1.1f : 0; // Mover en sentido antihorario

    // Decrementar el ángulo para mover en sentido horario (tecla V)
    ...
    // Actualizar la posición de la luz en forma circular
